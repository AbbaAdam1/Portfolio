        ...
        <div className="float group">
          ...
          <div className="sm:flex items-center justify-between pt-5">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center text-white hover:text-teal-300 gap-x-2 focus-visible:text-teal-300"
              aria-label="Pokemon Box GitHub repository"
            >
        ...
        <div className="float group">
          ...
          <div className="sm:flex items-center justify-between pt-5">
            ...
            <a
              ...
              rel="noreferrer"
              className="inline-flex items-center text-white hover:text-teal-300 gap-x-2 focus-visible:text-teal-300"
              aria-label="Harmony Hub GitHub repository"
            >
              <span className="dark:text-slate-400">GitHub:</span>
              <span className="sr-only">GitHub</span>
              <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="float group">
          ...
          <div className="sm:flex items-center justify-between pt-5">
            ...
            <a
              ...
              rel="noreferrer"
              className="inline-flex items-center text-white hover:text-teal-300 gap-x-2 focus-visible:text-teal-300"
              aria-label="Bike Share Data Analytics GitHub repository"
            >
              <span className="dark:text-slate-400">GitHub:</span>
              <span className="sr-only">GitHub</span>
              <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
