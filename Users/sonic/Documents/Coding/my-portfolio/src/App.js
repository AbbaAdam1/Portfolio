...
/////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
document.querySelectorAll('.dim-on-hover').forEach(item => {
    item.addEventListener('mouseenter', () => {
        document.querySelectorAll('.dim-on-hover').forEach(elem => {
            if (elem !== item) {
...
function App() {
  ...
  return (
    <div className="flex p-24">
      <div className="fixed">
        <h1 className="text-5xl font-bold">Mahamadou Adam</h1>
        <h2 className="pt-3 text-xl font-bold">Full-Stack Engineer</h2>
        <p className="pt-5 text-gray-400">I be building stuff, ya feel?</p>
...
<ul class="text-slate-500  fixed bottom-0 left-70 ml-1 mb-24 flex items-center">
    ...
    <a class="block hover:text-teal-400" href="https://www.linkedin.com/in/mahamadou-adam-a12704148/" target="_blank" rel="noreferrer">
      ...
      <h1 className="text-4xl">About</h1>
        ...
        <div className="float dim-on-hover">
          ...
          <p className="font-normal text-sm text-gray-700 pb-5 pt-5 dark:text-gray-400">Designed, developed, and deployed web apps using industry-standard practices. Demonstrated full-stack Java capability through team and individual projects. Utilized front-end dev with JavaScript and React. Built secure server-side apps with robust data handling.</p>
        </div>
        ...
        <div className="float dim-on-hover">
          ...
          <p className="font-normal text-sm text-gray-700 pb-5 pt-5 dark:text-gray-400">Collaborated with a team to develop the user interface of a web application with HTML, CSS, Java, and JavaScript. Created visually appealing interfaces that enhanced user engagement and facilitated seamless navigation.</p>
        </div>
        <div className="float">
        ...
        <a className="inline-flex items-center pr-1 leading-tight font-medium text-slate-200 group border-b border-transparent pb-px transition hover:border-teal-300" href="https://pokemon-box-nine.vercel.app/" target="_blank">View Full Resume  </a>
        ...
        <h1 className="text-4xl pb-5 pt-24">Projects</h1>
        ...
        <div className="float">
          ...
          <p className="font-normal text-sm text-gray-700 pb-5 pt-5 dark:text-gray-400">Developed an app that displays albums using Spotify API, and allows playing audio clips from each album using an audio player I built in JavaScript.</p>
        ...
        <div className="float">
          ...
          <a className="text-white hover:text-teal-300 focus-visible:text-teal-300" href="https://github.com/AbbaAdam1/pokemon-box/" target="_blank" rel="noreferrer"><span class="sr-only">GitHub</span><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg></a>
          </div>
          <p className="font-normal text-sm text-gray-700 pb-5 pt-5 dark:text-gray-400">Developed a Pokemon database website where users can create an account and log-in to store, read, and delete Pokemon data.</p>
          <div className="flex flex-col space-y-2">
            <div className="flex space-x-2">
        ...
        <div className="pl-24 pr-2 text-white">+1 317-464-3056</div>
        <svg stroke="currentColor" fill="white" stroke-width="1" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/></svg>
        </div>
        </div>
        </a>
        ...
        <div className="pl-24 pr-2 text-white">mahadamsp@gmail.com</div>
        <svg stroke="currentColor" fill="white" stroke-width="1" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/></svg>
        </div>
        </div>
        </a>
        ...
        <div className="pl-24 text-white">Indianapolis, Indiana</div>
        </div>
        </div>
